...
output:
  xaringan::moon_reader:
    css: ["assets/mtheme_max.css", "assets/fonts_mtheme_max.css", "styles.css"]
    lib_dir: libs
    nature:
...
* We added homework problems to the course website. These will not be graded. The answers are at the end of the textbook. Successfully completing these will help you prepare for the midterm and final exams. https://spring2022.data606.net/assignments/homework_ungraded/
...
results <- read_sheet('https://docs.google.com/spreadsheets/d/1Ig9qdkV_SnJutSqR_87vOdHiw5rr0nhE0ao1MKft3Uo/edit?resourcekey#gid=1675807648') %>% as.data.frame()
...
---
# New DAACS Self-Efficacy Items `r hexes(c('daacs'))`

**Soliciting your feedback**

1. Describe how you interpreted these questions. For example, what context did you think about when answering these questions? Refer to specific items if needed.

2. Were these items confusing in any way? Which ones? How?

3. What suggestions do you have on how you might improve these items for clarity (e.g., wording, formatting)?

Please provide your feedback here: https://forms.gle/bFsFbfiLDeqrcxZL6  
This is not a graded exercise, you would be helping us out by completing this survey.

.small[
For more info on the DAACS SRL assessment, see [Lui, A., Franklin, D., Akhmedjanova, D., Gorgun, G., Bryer, J., Andrade, H., & Cleary, T. (2018). Validity evidence of the internal structure of the DAACS Self-Regulated Learning Survey. *Future Review: International Journal of Transition, College, and Career Success, 1*(1), 1-18.](https://secureservercdn.net/198.71.233.37/f0s.3d9.myftpupload.com/wp-content/uploads/2020/03/Future-Review-Issue-1.pdf)
]
